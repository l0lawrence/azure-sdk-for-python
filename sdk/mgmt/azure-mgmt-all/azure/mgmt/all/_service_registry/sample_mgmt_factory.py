...
class WidgetsOperations(Protocol):
    ...
    def begin_delete_widget(self, resource_group_name: str, widget_name: str, **kwargs: Any) -> LROPoller[None]: ...
...
class WidgetKeyOperations(Protocol):
    ...
    def begin_delete_widget_key(self, resource_group_name: str, widget_name: str, key_name: str, **kwargs: Any) -> LROPoller[None]: ...
