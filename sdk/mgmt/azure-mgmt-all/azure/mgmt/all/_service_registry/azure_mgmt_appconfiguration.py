...
class _PostOperations(Protocol):
    def list_keys(
        self, resource_group_name: str, config_store_name: str, skip_token: Optional[str] = None, **kwargs: Any
    ) -> ItemPaged[ApiKey]: ...
...
class _PatchOperations(Protocol):
    def begin_update(
        self,
        resource_group_name: str,
        config_store_name: str,
...
class _DeleteOperations(Protocol):
