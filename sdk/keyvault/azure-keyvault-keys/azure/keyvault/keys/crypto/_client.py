...
class CryptographyClient(KeyVaultClientBase):
    ...
    @distributed_trace
def create_rsa_private_key(self) -> KeyVaultRSAPrivateKey:        """Create an `RSAPrivateKey` implementation backed by this `CryptographyClient`, as a `KeyVaultRSAPrivateKey`.
