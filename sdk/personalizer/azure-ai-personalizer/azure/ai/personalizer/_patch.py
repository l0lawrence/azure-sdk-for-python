...
class PersonalizerAdministrationClient:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def import_model(self, body: IO, **kwargs: Any) -> None:  
        """Model File.
    ...
    @distributed_trace
    def reset_model(self, **kwargs: Any) -> None:  
        """Reset Model.
    ...
    @distributed_trace
    def delete_logs(self, **kwargs: Any) -> None:  
        """Logs.
...
class PersonalizerClient:
    ...
    @distributed_trace
    def activate(self, event_id: str, **kwargs: Any) -> None:  
        """Activate Event.
