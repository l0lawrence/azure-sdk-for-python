...
from azure.identity._exceptions import CredentialUnavailableErrorfrom azure.identity._internal.utils import within_dacfrom ._utils import wrap_exceptions, resolve_tenant
