...
def _get_telemetry_values(self, *args: Any, **kwargs: Any) -> Dict:        # Note: the is_anonymous is not reliable here, create_or_update will log is_anonymous from parameter.
