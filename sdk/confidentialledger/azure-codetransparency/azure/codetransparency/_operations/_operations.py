...
# --------------------------------------------------------------------------
from typing import Any, Optional, MutableMapping, TypeVar, Callable, Dict, Iterator, Union, Literal, cast
...
class CodeTransparencyClientOperationsMixin(
    ClientMixinABC[Any, CodeTransparencyClientConfiguration]
):
