...
class AcsEmailDeliveryReportReceivedEventData(_model_base.Model):
    ...
    delivery_attempt_time_stamp: Optional[datetime.datetime] = rest_field(name="deliveryAttemptTimeStamp", format="rfc3339")
...
class AcsIncomingCallCustomContext(_model_base.Model):
    ...
    :ivar viop_headers: Voip Headers for incoming call.
    :vartype viop_headers: dict[str, str]
    """

    sip_headers: Optional[Dict[str, str]] = rest_field(name="sipHeaders")
    """Sip Headers for incoming call."""
    viop_headers: Optional[Dict[str, str]] = rest_field(name="viopHeaders")
    ...
    def __init__(
        ...
        *,
        ...
        viop_headers: Optional[Dict[str, str]] = None,
    ):
        ...
...
class DeviceTelemetryEventProperties(_model_base.Model):
    ...
    body: Optional[Dict[str, str]] = rest_field()
...
class DeviceTwinInfo(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    cloud_to_device_message_count: Optional[int] = rest_field(name="cloudToDeviceMessageCount")
...
class EventGridEvent(_model_base.Model):
    ...
    metadata_version: Optional[str] = rest_field(name="metadataVersion")
...
class MediaJobError(_model_base.Model):
    ...
    code: Optional[Union[str, "_models.MediaJobErrorCode"]] = rest_field()
    ...
    category: Optional[Union[str, "_models.MediaJobErrorCategory"]] = rest_field()
    """Helps with categorization of errors. Known values are: \"Service\", \"Download\", \"Upload\",
     \"Configuration\", \"Content\", and \"Account\"."""
    retry: Optional[Union[str, "_models.MediaJobRetry"]] = rest_field()
    ...
    details: Optional[List["_models.MediaJobErrorDetail"]] = rest_field()
    ...
    def __init__(
        self,
        *,
        code: Optional[Union[str, "_models.MediaJobErrorCode"]] = None,
        message: Optional[str] = None,
        category: Optional[Union[str, "_models.MediaJobErrorCategory"]] = None,
        retry: Optional[Union[str, "_models.MediaJobRetry"]] = None,
        details: Optional[List["_models.MediaJobErrorDetail"]] = None,
    ):
        ...
