...
from ..._operations._operations import build_event_grid_publish_cloud_event_request, build_event_grid_publish_custom_event_request, build_event_grid_publish_event_grid_event_request
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    @overload
    async def publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self,
        events: List[_models.CustomEventEvent],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
    ...
    async def publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self,
        events: Union[List[_models.CustomEventEvent], IO],
        **kwargs: Any
    ) -> None:
        """Publish custom events.
