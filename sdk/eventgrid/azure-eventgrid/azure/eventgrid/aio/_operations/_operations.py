...
from ..._operations._operations import (
    ...
    build_event_grid_publish_custom_event_request,
    build_event_grid_publish_custom_events_request,
    build_event_grid_publish_event_grid_event_request,
    build_event_grid_publish_event_grid_events_request,
)
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    @overload
    async def _publish_event_grid_event(  # pylint: disable=inconsistent-return-statements,protected-access
        self, events: _models._models.EventGridEvent, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...

    @overload
    async def _publish_event_grid_event(  # pylint: disable=inconsistent-return-statements
    ...
    @overload
    async def _publish_custom_event(  # pylint: disable=inconsistent-return-statements,protected-access
        self, events: _models._models.CustomEventEvent, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...

    @overload
    async def _publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self, events: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...
