...
def build_event_grid_publish_event_grid_events_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_event_grid_publish_event_grid_event_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_event_grid_publish_custom_events_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_event_grid_publish_custom_event_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    def _publish_cloud_event(  # pylint: disable=inconsistent-return-statements,protected-access
        self, events: _models._models.CloudEventEvent, *, channel_name: Optional[str] = None, **kwargs: Any
    ) -> None:
        """Publish CloudEvents.

        :param events: Events being published. Required.
        :type events: ~azure.eventgrid.models.CloudEventEvent
        :keyword channel_name: Required only when publishing to partner namespaces with partner topic
         routing mode ChannelNameHeader. Default value is None.
        :paramtype channel_name: str
        :keyword content_type: content type. Default value is "application/cloudevents-batch+json;
    ...
    @overload
    def _publish_event_grid_event(  # pylint: disable=inconsistent-return-statements,protected-access
        self, events: _models._models.EventGridEvent, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...

    @overload
    def _publish_event_grid_event(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def _publish_event_grid_event(  # pylint: disable=inconsistent-return-statements
        self, events: Union[_models._models.EventGridEvent, JSON, IO], **kwargs: Any
    ) -> None:
        """Publish EventGridEvents.

        :param events: Events being published. Is one of the following types: EventGridEvent, JSON, IO
         Required.
        :type events: ~azure.eventgrid.models.EventGridEvent or JSON or IO
        :keyword content_type: content type. Default value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
    ...
    def _publish_custom_events(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_event_grid_publish_custom_events_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
    ...
    @overload
    def _publish_custom_event(  # pylint: disable=inconsistent-return-statements,protected-access
        self, events: _models._models.CustomEventEvent, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...

    @overload
    def _publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self, events: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...
    ...
    @distributed_trace
    def _publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self, events: Union[_models._models.CustomEventEvent, JSON, IO], **kwargs: Any
    ) -> None:
        """Publish custom events.

        :param events: Events being published. Is one of the following types: CustomEventEvent, JSON,
         IO Required.
        :type events: ~azure.eventgrid.models.CustomEventEvent or JSON or IO
        :keyword content_type: content type. Default value is None.
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
        ...
        request = build_event_grid_publish_custom_event_request(
            content_type=content_type,
            api_version=self._config.api_version,
            content=_content,
            headers=_headers,
