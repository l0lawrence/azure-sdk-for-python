...
def build_event_grid_acknowledge_cloud_events_request(  # pylint: disable=name-too-long
    topic_name: str, event_subscription_name: str, *, content: _models.LockTokens, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    def acknowledge_cloud_events(
        self, topic_name: str, event_subscription_name: str, lock_tokens: _models.LockTokens, **kwargs: Any
    ) -> _models.LockTokensResult:
        ...
        :type lock_tokens: ~azure.eventgrid.models.LockTokens
        :keyword content_type: content type. Default value is "application/json; charset=utf-8".
        :paramtype content_type: str
        :keyword bool stream: Whether to stream the response of this operation. Defaults to False. You
         will have to context manage the returned stream.
        :return: LockTokensResult. The LockTokensResult is compatible with MutableMapping
        :rtype: ~azure.eventgrid.models.LockTokensResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.LockTokensResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.LockTokensResult, response.json())
