...
def build_event_grid_publish_event_grid_event_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_event_grid_publish_custom_event_request(
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    ...
    @overload
    def publish_custom_event(  # pylint: disable=inconsistent-return-statements
        self,
