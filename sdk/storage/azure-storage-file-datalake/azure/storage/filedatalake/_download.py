...
encryption_context = self._downloader._response.response.headers.get('x-ms-encryption-context')  , protected-access        acl = self._downloader._response.response.headers.get('x-ms-acl')
