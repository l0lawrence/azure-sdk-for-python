,too-many-statements# coding=utf-8
# --------------------------------------------------------------------------
...
def build_create_run_request(run_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/notebooks/runs/{runId}")
...
def build_get_status_request(run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_cancel_run_request(run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/notebooks/runs/{runId}/cancel")
    path_format_arguments = {
        "runId": _SERIALIZER.url("run_id", run_id, "str", max_length=100),
    }
...
def build_get_snapshot_request(run_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/notebooks/runs/{runId}/snapshot")
    path_format_arguments = {
        "runId": _SERIALIZER.url("run_id", run_id, "str", max_length=100),
    }
