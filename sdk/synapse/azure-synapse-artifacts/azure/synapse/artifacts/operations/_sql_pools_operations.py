...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/sqlPools")
...
def build_get_request(sql_pool_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/sqlPools/{sqlPoolName}")
...
class SqlPoolsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.SqlPoolInfoListResult:
        """List Sql Pools.
    ...
    @distributed_trace
    def get(self, sql_pool_name: str, **kwargs: Any) -> _models.SqlPool:
        """Get Sql Pool.
