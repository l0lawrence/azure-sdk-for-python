...
def build_get_request(operation_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/notebookOperationResults/{operationId}")
...
class NotebookOperationResultOperations:
    ...
    @distributed_trace
    def get(self, operation_id: str, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
