...
from ...operations._sql_script_operations import (
    build_create_or_update_sql_script_request,
    build_delete_sql_script_request,
    build_get_sql_script_request,
...
class SqlScriptOperations:
    ...
    async def begin_delete_sql_script(self, sql_script_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._delete_sql_script_initial(  # type: ignore
                sql_script_name=sql_script_name,
                api_version=api_version,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    async def begin_rename_sql_script(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._rename_sql_script_initial(  # type: ignore
                sql_script_name=sql_script_name,
                new_name=new_name,
                api_version=api_version,
                content_type=content_type,
